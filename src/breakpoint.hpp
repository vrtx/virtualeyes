...
namespace veyes
{
        ...
        public:
                ...
                mi_bkpt *gdb_breakpoint;        // GDB/MI breakpoint
                ...
                void add_snapshot();            // register a new collection event with the breakpoint and session
                void handle_bp();               // callback for triggered breakpoint
